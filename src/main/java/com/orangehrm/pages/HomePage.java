...
public class HomePage {
	...
	//Method to Navigate to Leave tab
	public void clickOnLeaveTab() {
		actionDriver.dismissAnyOpenDropdown();
		actionDriver.click(leaveTab);
	}

	//Method to Navigate to Time tab
	public void clickOnTimeTab() {
		actionDriver.dismissAnyOpenDropdown();
		actionDriver.click(timeTab);
	}

	//Method to Navigate to Recruitment tab
	public void clickOnRecruitmentTab() {
		actionDriver.dismissAnyOpenDropdown();
		actionDriver.click(recruitmentTab);
	}

	//Method to Navigate to My Info tab
	public void clickOnMyInfoTab() {
		actionDriver.dismissAnyOpenDropdown();
		actionDriver.click(myInfoTab);
	}
